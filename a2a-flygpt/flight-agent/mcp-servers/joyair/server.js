...
// Reused from the mcp-flygpt lesson — in a real deployment, Joy Air would
// write and host this themselves. Minimal MCP server exposing one tool:
// search_flights (and book_flight).
