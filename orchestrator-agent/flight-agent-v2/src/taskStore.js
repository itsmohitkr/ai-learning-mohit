...
//
// Identical to hotel-agent's taskStore.js. This is intentional: every
// specialist agent in this architecture uses the same task lifecycle
// shape, so an orchestrator never needs agent-specific handling.
//
